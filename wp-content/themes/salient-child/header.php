...
# hide certain frontend elements via css in function.php
							...
							if($has_main_menu == 'true') {
							    wp_nav_menu( array('walker' => new Nectar_Arrow_Walker_Nav_Menu, 'theme_location' => 'top_nav', 'container' => '', 'items_wrap' => '%3$s' ) );
									...
									{echo '
										...
										<a href="'.esc_url( get_permalink( get_page_by_title( 'Doc Fornitori' ) ) ).'">
										<span style="color:red">Area MacMove</span>
										</a>
										</li>
									';
									}
