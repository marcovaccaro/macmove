...
<div id="footer-outer" <?php echo $midnight_non_reveal; ?> data-full-width="<?php echo $footer_full_width; ?>" data-using-widget-area="<?php echo $using_footer_widget_area; ?>">
...
#pale
# : link to doc if logged in

                if(is_user_logged_in())
                {?>

<li class="menu-item menu-item-type-post_type menu-item-object-page menu-item-9999">
<a id="mob-doc-fornitori-link" href="<?php echo esc_url( get_permalink( get_page_by_title( 'Doc Fornitori' ) ) ); ?>">
Area MacMove
</a>
</li>
                <?php
