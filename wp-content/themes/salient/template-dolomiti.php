<?php
/*template name: PDF - Dolomiti*/
get_header(); ?>
<? // fornitore
$fornitore = 'dolomiti';
$fornitore_rag_soc = 'Dolomiti S.p.A.';
...
<div class="container-wrap">
	...
	<div class="container main-content">
		...
		<div class="row">
<?php if( !post_password_required( $post )): ?>	<!-- #################################################################### -->	<?php include_once('doc-fornitori.php'); ?>	<!-- ####################################################################/copiato --><?php endif; ?>			<?php if(have_posts()) : while(have_posts()) : the_post(); ?>				<?php the_content(); ?>
			<?php endwhile; endif; ?>
